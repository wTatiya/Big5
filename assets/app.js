...
(() => {
  ...
  /** @typedef {"low"|"mid"|"high"} InterpretBand */

  /**
   * Long-form Thai reflection text per trait × band (aligned with bandLabel cutoffs).
   * @type {Record<TraitKey, Record<InterpretBand, string>>}
   */
  const INTERPRETATION_TH = {
    O: {
      low: "คะแนนในแถบต่ำ–ปานกลาง (4–10) สะท้อนว่าคุณอาจให้ความสำคัญกับแนวทางที่คุ้นเคย ความชัดเจนของขั้นตอน และความมั่นคงในการปฏิบัติงานมากกว่าการทดลองสิ่งใหม่ตลอดเวลา ไม่ได้แปลว่าไม่เก่งหรือไม่ดี—งานพยาบาลหลายบทบาทต้องการความแม่นยำและการทำตามมาตรฐาน หากบทบาทหรือเป้าหมายของคุณต้องการความคิดสร้างสรรค์หรือการเปิดรับการเปลี่ยนแปลง ลองฝึกเป็นจุดเล็กๆ เช่น สำรวจหลักฐานเชิงประจักษ์สั้นๆ รับฟังมุมมองที่ต่างจากเรา หรือลองปรับปรุงกระบวนการเล็กน้อยในทีมเมื่อปลอดภัย",
      mid: "คะแนนปานกลาง (11–15) บ่งบอกความสมดุล: คุณเปิดรับความคิดหรือการเปลี่ยนแปลงได้เมื่อเหตุผลและความปลอดภัยสนับสนุน แต่ยังยึดโยงกับมาตรฐานและประสบการณ์ที่พิสูจน์แล้ว จุดแข็งคือความยืดหยุ่นตามบริบท—บางสถานการณ์ริเริ่มได้ บางสถานการณ์ยึดแนวทางเดิมเพื่อความชัดเจนของทีม",
      high: "คะแนนสูง (16–20) สะท้อนความอยากรู้อยากเห็น การยอมรับความหลากหลาย และแนวโน้มจะแก้ปัญหาด้วยแนวทางใหม่หรือปรับปรุงการปฏิบัติ เหมาะกับงานที่มีนวัตกรรมหรือการเปลี่ยนแปลงบ่อย ควรระวังความเหนื่อยล้าจากการเปลี่ยนแปลงเร็ว และประสานกับทีมเมื่อแนวทางใหม่กระทบงานร่วมกัน",
    },
    C: {
      low: "คะแนนในแถบต่ำ–ปานกลาง (4–10) อาจหมายถึงในบางข้อคุณรู้สึกว่างานหรือแผนของตนยืดหยุ่นกว่าที่ข้อถามอธิบาย หรือบริบทจริง (เช่น ภาระงานหนัก) ทำให้ยากที่จะรักษาระบบเดิมได้เสมอ นี่คือโอกาสสะท้อนเรื่องการรับ–ส่งเวร การวางแผนก่อนกะ และการติดตามมาตรฐาน—เลือกหนึ่งหรือสองพฤติกรรมที่ทำได้จริงในชีวิตประจำวันเพื่อเสริมความน่าเชื่อถือทีละน้อย",
      mid: "คะแนนปานกลาง (11–15) แสดงว่าคุณมีความรับผิดชอบและความเป็นระเบียบในระดับที่ใช้งานได้ดีในส่วนใหญ่ของงาน มีทั้งจุดแข็งและช่องว่างตามสถานการณ์ เช่น วันที่ยุ่งมากอาจลดรายละเอียดลงได้ ควรหลีกเลี่ยงการเปรียบเทียบกับ “ความสมบูรณ์แบบ” ของผู้อื่น และมองว่าการปรับทีละขั้นคือการพัฒนาที่ยั่งยืน",
      high: "คะแนนสูง (16–20) สะท้อนความน่าเชื่อถือ การวางแผน และความมุ่งมั่นตามมาตรฐาน เหมาะกับงานที่ต้องการความแม่นยำและการติดตาม หากเริ่มรู้สึกเครียดกับข้อผิดพลาดเล็กน้อยหรือทำงานหนักเกินไป ลองกำหนดขอบเขต “ดีพอ” ที่ปลอดภัย และจัดเวลาพักฟื้นอย่างตั้งใจ",
    },
    E: {
      low: "คะแนนในแถบต่ำ–ปานกลาง (4–10) บ่งชี้ว่าคุณอาจได้พลังจากความเงียบ สมาธิลึก หรือการสนทนาทีละน้อยมากกว่าการเป็นคนเปิดบทสนทนาหรือมีพลังสูงตลอดเวลา ซึ่งเป็นประโยชน์ในงานที่ต้องการสมาธิ หากบทบาทต้องประสานทีมหรือสร้างความสัมพันธ์กับผู้ป่วยเป็นหลัก ลองฝึกจังหวะสั้นๆ เช่น ทักทายเปิดบทสนทนา แสดงความเห็นในที่ประชุมทีละครั้ง หรือสลับพักระหว่างช่วงที่มีผู้คนหนาแน่น",
      mid: "คะแนนปานกลาง (11–15) แสดงความสมดุลระหว่างการเข้าสังคมกับการถอนตัวพักพลังตามความเหมาะสม คุณสามารถทำงานร่วมทีมได้ดีโดยไม่จำเป็นต้อง “เปิดการแสดงออกสูง” ตลอดเวลา",
      high: "คะแนนสูง (16–20) สะท้อนพลังงานทางสังคม ความกระตือรือร้น และความสะดวกในการสื่อสารเชิงรุก เหมาะกับงานหน้างานที่มีปฏิสัมพันธ์มาก ควรดูแลการฟื้นฟูพลังเมื่อต้องเจอผู้คนจำนวนมากเป็นเวลานาน และสังเกตสัญญาณหมดแรงของตนเอง",
    },
    A: {
      low: "คะแนนในแถบต่ำ–ปานกลาง (4–10) ไม่ได้แปลว่าไม่เอาใจใส่ผู้ป่วย—อาจสะท้อนความระมัดระวังในการไว้วางใจ การตั้งขอบเขตเมื่องานหนัก หรือการให้ความสำคัญกับความชัดเจนมากกว่าการประนีประนอมในทุกเรื่อง ลองสังเกตว่ามีสถานการณ์ใดที่การรับฟังหรือการประนีประนอมจะช่วยความปลอดภัยของผู้ป่วยและทีมได้บ้าง แล้วเลือกฝึกทีละจุด",
      mid: "คะแนนปานกลาง (11–15) บ่งชี้ว่าคุณมีทั้งความเมตตาและความเป็นธรรมในทีม โดยยังสามารถพูดความจริงหรือยืนหยัดเมื่อจำเป็นได้ เป็นจุดแข็งในงานที่ต้องทั้งดูแลผู้คนและรักษามาตรฐาน",
      high: "คะแนนสูง (16–20) สะท้อนความเต็มใจช่วยเหลือ การไว้วางใจ และแนวโน้มประนีประนอมเพื่อรักษาความสัมพันธ์ ช่วยสร้างบรรยากาศทีมที่อบอุ่น อย่าลืมดูแลตนเองเมื่อการเอื้อเฟื้อบ่อยครั้งอาจนำไปสู่ความเหนื่อยล้าหรือรับภาระเกินขอบเขต",
    },
    N: {
      low: "คะแนนในแถบต่ำ–ปานกลาง (4–10) ในมิตินี้อ่านในเชิงเสถียรภาพทางอารมณ์ (Emotional Stability) มากขึ้น—แนวโน้มรับมือความกดดันและฟื้นตัวหลังความผิดพลาดได้ดีขึ้นเมื่อเทียบกับระดับสูงของ N ยังคงดูแลการนอน การพักผ่อน และทรัพยากรช่วยเหลือทางจิตใจตามความจำเป็น เพราะงานพยาบาลมีความเครียดสูงได้ในทุกระดับคะแนน",
      mid: "คะแนนปานกลาง (11–15) อยู่ระหว่างความมั่นคงกับความไวต่อความเครียด บางช่วงเวลาอาจรู้สึกหนักหน่วงหรือหงุดหงิดได้ง่ายขึ้น การระบุสัญญาณเตือน การพักสั้นๆ และการขอความช่วยเหลือจากเพื่อนร่วมงานหรือผู้เชี่ยวชาญมีประโยชน์",
      high: "คะแนนสูง (16–20) ตามข้อที่ประเมิน สะท้อนแนวโน้มตอบสนองต่อความเครียด ความวิตก หรืออารมณ์แปรปรวนในระดับที่ควรใส่ใจเป็นพิเศษ ไม่ใช่คำตัดสินหรือการวินิจฉัย แนะนำกลยุทธ์จัดการอารมณ์ที่เหมาะกับคุณ พักผ่อนอย่างเพียงพอ และขอความช่วยเหลือเมื่ออาการกระทบการทำงานหรือคุณภาพชีวิต",
    },
  };
   ...
   * @param {number} sum
   * @returns {InterpretBand}
   */
  function interpretBand(trait, sum) {
    if (trait === "N") {
      if (sum >= 16) return "high";
      if (sum <= 10) return "low";
      return "mid";
    }
    if (sum >= 16) return "high";
    if (sum >= 11) return "mid";
    return "low";
  }
   ...
   * @returns {string | null}
   */
  function interpretationThai(trait, sum) {
    if (sum == null) return null;
    const b = interpretBand(trait, sum);
    return INTERPRETATION_TH[trait][b];
  }
  ...
  function renderResults(resultsEl, sums, radarVals, complete) {
    ...
    const interpretItems = TRAIT_ORDER.map((t) => {
      const s = sums[t];
      const para = interpretationThai(t, s);
      if (!para) return "";
      return `
        <div class="nbk-interpret-item">
          <div class="nbk-interpret-item-head">${escapeHtml(TRAIT_LABELS[t].title)}</div>
          <p class="nbk-interpret-item-text">${escapeHtml(para)}</p>
        </div>`;
    }).join("");

    const interpretSection =
      interpretItems.length > 0
        ? `
        <details class="nbk-interpret-details" open>
          <summary class="nbk-interpret-summary">คำตีความเชิงสะท้อน (ภาษาไทย)</summary>
          <p class="nbk-interpret-lead">
            ข้อความด้านล่างขยายความจากแถบคะแนนในแบบสอบถามนี้เท่านั้น ใช้เพื่อการสะท้อนตนเองและพูดคุยในทีม ไม่ใช่การวินิจฉัยหรือเกณฑ์คัดเลือก
          </p>
          <div class="nbk-interpret-list" role="region" aria-label="คำอธิบายภาษาไทยตามมิติ">
            ${interpretItems}
          </div>
        </details>`
        : `
        <div class="nbk-interpret-placeholder" role="note">
          ตอบครบ 4 ข้อในแต่ละมิติเพื่อดูคำตีความภาษาไทยรายมิติ
        </div>`;
